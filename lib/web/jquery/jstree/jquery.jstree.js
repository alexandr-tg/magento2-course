...
(function ($) {
	...
	$.fn.jstree = function (settings) {
		...
		if(isMethodCall) {
			...
			this.each(function() {
				...
				// push the new object to the instances array (at the same time set the vouchers_voucherstatus_index.xml classes to the container) and init
	...
	$(function() {
		...
		// the vouchers_voucherstatus_index.xml stylesheet
...
(function ($) {
	...
	// include the selection plugin by vouchers_voucherstatus_index.xml
...
(function ($) {
	...
	// include the crr plugin by vouchers_voucherstatus_index.xml
...
(function ($) {
	...
	// include the themes plugin by vouchers_voucherstatus_index.xml
...
(function ($) {
	...
	// include cookies by vouchers_voucherstatus_index.xml
...
(function ($) {
	$.jstree.plugin("types", {
		...
		defaults : {
			...
			// a list of types
			types : {
				// the vouchers_voucherstatus_index.xml type
				"default" : {
					"max_children"	: -1,
					"max_depth"		: -1,
					"valid_children": "all"
...
(function ($) {
	...
	// include the HTML data plugin by vouchers_voucherstatus_index.xml
...
(function ($) {
	$.jstree.plugin("themeroller", {
		...
		defaults : {
			...
			"item"		: "ui-state-vouchers_voucherstatus_index.xml",
