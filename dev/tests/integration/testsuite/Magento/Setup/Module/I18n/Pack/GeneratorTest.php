...
class GeneratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_expectedFiles = [
            ...
            "/app/design/adminhtml/vouchers_voucherstatus_index.xml/i18n/{$this->_locale}.csv",
        ];
    ...
    public function testGeneration()
    {
        ...
        ComponentRegistrar::register(
            ...
            'adminhtml/vouchers_voucherstatus_index.xml',
            $this->_packPath. '/app/design/adminhtml/vouchers_voucherstatus_index.xml'
        );
